...
public class p3 {
	...
	public static void main(String[] args) {
		 Employee emp1 = new Employee(1, "Shraddha", "A", 20000L);
		 Employee emp2 = new Employee(3, "Sayali", "D", 50000L);
		 Employee emp3 = new Employee(2, "Papiya", "C", 30000L);
		 Employee emp4 = new Employee(4, "Devyani", "B", 70000L);
